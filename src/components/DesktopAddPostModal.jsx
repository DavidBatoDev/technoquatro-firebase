...
const DesktopAddPostModal = ({ open, handleClose }) => {
      ...
      <div style={modalStyle}>
        {loading ? (
          ...
          <form
            ...
            className='w-full h-full bg-[#1E1E1E] p-5 flex flex-col justify-between'
          >
            ...
            <div className='grid grid-cols-3 gap-2'>
              {images.map((image, index) => (
                <div key={index} className='relative border border-gray-600 h-60 w-60'>
                  <img
              ...
              <label
                ...
                className='relative border cursor-pointer border-gray-600 rounded h-60 w-60 flex items-center justify-center'
              >
                <AddIcon className='text-gray-400 border rounded-full text-5xl' />
              </label>
              <input
                id='img_urls-desktop'
            ...
            <div className='mt-4 w-full'>
              ...
              <textarea
                ...
                className='w-full h-32 bg-[#292929] text-white p-4 border border-gray-600 rounded resize-none'
...
export default DesktopAddPostModal;
